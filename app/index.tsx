...
export default function HomePage() {
  ...
  return (
    <LinearGradient
      colors={['#c4d3ff', '#ffffff']} 
      start={{ x: 0, y: 0 }} 
      end={{ x: 0, y: 1 }} 
      style={{ flex: 1 }}
    >
      <StyledView className="flex-1 justify-center items-center p-4">
        <StyledView className="items-center mb-12 mt-12"> 
          <StyledImage
        ...
        <StyledView className="w-full px-8">
          ...
          <StyledTextInput
            ...
            className="mb-4 h-12 bg-white rounded-full px-4"
          />
          <StyledPressable className="bg-blue-500 h-12 rounded-full justify-center items-center mb-4" onPress={handleLogIn}>
            <StyledText className="text-white text-lg">Sign In</StyledText>
          </StyledPressable>
          <StyledPressable onPress={() => console.log("Continue as guest")}>
            <StyledText className="text-center text-lg">Continue as guest</StyledText>
          </StyledPressable>
